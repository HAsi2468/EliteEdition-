/**
 * SKU Helper Utility for Elite Online & Inventory Management
 * Handles SKU extraction, base design code normalization, and size suffix parsing.
 */
 ...
 */
function extractBaseSku(skuCode) {
 ...
 */
function extractSizeFromSku(skuCode) {
  if (!skuCode || typeof skuCode !== 'string') return '';
  const trimmed = skuCode.trim();
