...
const jobCardSchema = new mongoose.Schema(
  {
    ...
    deliveryMtr:      { type: String, default: '', trim: true },
    ...
    printStatus:      { type: String, default: 'Printing Pending', enum: ['Printing Pending', 'Printing In Progress', 'Partial Complete', 'Printing Done'] },
    printDate:        { type: String, default: '' },
    printMtr:         { type: String, default: '', trim: true },
    fusingStatus:     { type: String, default: 'Fusing Pending', enum: ['Fusing Pending', 'Fusing In Progress', 'Partial Complete', 'Fusing Done'] },
    ...
    deliveryStatus:   { type: String, default: 'Delivery Pending', enum: ['Delivery Pending', 'Delivery In Progress', 'Partial Complete', 'Delivery Done'] },
